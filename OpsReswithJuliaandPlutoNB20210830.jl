...
# ╔═╡ ffe2c2d8-c2d2-45e5-b32a-f3d525df7a4e
using Plots

# ╔═╡ a8b5404c-ec9b-454f-a20a-0cab8c625b72
using JSON, CSV

# ╔═╡ 455e4f92-030e-4a36-8d6f-7e6472963625
using Markdown

# ╔═╡ 6ced579e-66aa-44bb-a7c6-130252735daf
using InteractiveUtils

# ╔═╡ b79ec915-a0e7-4295-9cc2-744094f36d74
using ModelingToolkit

# ╔═╡ 6a2fe644-2233-4b0f-ab9a-795b28094876
using PlutoUI,HypertextLiteral

# ╔═╡ f6875f74-07d1-11ec-0d50-639aa4532f30
md"""
##### สมุดโน๊ตแสดงผลการทำงานของโปรแกรม Julia สำหรับการวิจัยดำเนินงาน
#### (Operations Research Interactive Notebook)
"""

# ╔═╡ 3624376d-5329-456b-9367-64f4a4201600
md"""
_____________________________________________________________________________________
"""

# ╔═╡ 206f163b-486d-4e9b-8912-e0b5043e7e54
#md"""
###### รายการโปรแกรมการวิจัยดำเนินงานที่เขียนด้วยภาษา Julia 
###### (List of Operations Research Programs in Julia Programming Language)

# ╔═╡ 3ea75918-8147-40fc-b725-0f7455757964
#md"""
#1.Linear Programming กำหนดการเชิงเส้น

#2.Integer Programming กำหนดการจำนวนเต็ม

#3.Network and Analysis
...
# ╔═╡ b6fb7547-7791-4535-869c-0b6baf7ceb5e
md"""
_____________________________________________________________________________________
"""

# ╔═╡ cce5961d-4d32-4bbf-bcf0-887b596c5f8c
md"""
จากโค๊ตที่ต้องการจะให้เครื่องประมวลผล
import Pkg
using Pkg
JuMP.run()

สามารถเขียนโค๊ดได้ 2 รูปแบบได้แก่
1.เขียนตำสั่งแยกกันคนละบรรทัด ดังตัวอย่าง ก ในลำดับถัดไป หรือ 
2.เขียนโดยนำ begin_end block หรือ บล๊อกของโค๊ดโปรแกรม ดังตัวอย่าง ข


"""

# ╔═╡ ee73ef57-d66b-40d5-a43d-f30177d121bf
md"""
รูปแบบการเขียนแบบ ก.

คำสั่งหรือ statement เขียนแยกกันและอยู่กันคนละบรรทัด
"""

# ╔═╡ 48d0423f-9778-4b91-b162-01fa78db8ec2
JuMP.run()

# ╔═╡ 757eba2b-8e72-4392-a8d2-9395ceb35f1e
md"""
รูปแบบการเขียนแบบ ข. 

คำสั่งหรือ statement เขียนรวมกันและอยู่ภายใต้กรอบของบล็อก
โดยมี begin และ end วางไว้อยู่ก่อนหน้า และ หลังสุด ตามลำดับ
"""

# ╔═╡ 59b92546-aa2d-4ae6-b820-71f560c8ecaf
plot(rand(4))

# ╔═╡ f0213555-0ec1-47b6-8b01-c12d514fae20
json([1,2])

# ╔═╡ 4bfb2075-6174-4021-841f-51acfc8d881f
md"""
#### ตัวแปร
"""

# ╔═╡ daa46f20-18ae-4826-b439-0a6f3b0bcbf9
md"""
ในการเขียนโปรแกรมหากเราต้องการให้มีการเก็บค่าข้อมูลไว้ เรากำหนดกล่องเพื่อใช้บรรจุข้อมูลดังกล่าว เป็นที่รู้จักกันดีว่ากล่องนั้นใช้แทนสิ่งที่เรียกว่า "ตัวแปร" หรือ "variables" และเมื่อต้องการนำค่าไปเก็บไว้ที่กล่องหรือ variables ให้ดำเนินการดังนี้
1.name เป็นสตริงที่ใช้แทนค่าข้อความ
2.number เป็นตัวเลขที่ใช้แทนเลขจำนวนเต็ม
3.pie_value เป็นตัวเลขที่ใช้แทนเลขที่มีจุดทศนิยมหรือเศษส่วน หรือที่เรียกว่าจำนวนจริง
"""

# ╔═╡ 5f391504-c84f-4475-8b72-403689e8c7ee
name = "Phanu Waraporn"

# ╔═╡ 14534a7d-943d-4037-a8c0-36b207e11b95
number = 31

# ╔═╡ d589d3dd-ec30-4a02-8d2d-22c3efffb44f
pie_value = 3.141

# ╔═╡ c7544967-d44f-4d74-832a-543808edc1c0
md"""
#### การพิมพ์ตัวแปร
"""

# ╔═╡ 53b7cf23-4038-4927-b55c-24b6712c7e63
string(name)

# ╔═╡ f4dc3db7-59bd-4387-8a41-0bd978ee8fdc
typeof(0.2)

# ╔═╡ 1664be33-f0bb-4234-b683-8c2d6ce6c93b
typeof(50)

# ╔═╡ 489d2797-2766-4833-8ab6-f33a98613206
typeof("Phanu Waraporn")

# ╔═╡ 05b5d6e3-33a1-4ef5-bc06-c55ee0ee8fed
md"""
#### การกำหนดฟังก์ชัน (Defining Functions)
"""

# ╔═╡ 64fc3486-f141-47a2-a16f-3e1ddda88cc2
function plus_two_number(x)
      #perform addition operation
        return x + 2
end

# ╔═╡ f6e8c2bd-085b-4b12-8c2e-ca0c54747ac9
import Pkg

# ╔═╡ 5cd6ca55-40fe-4c6f-b6af-3ddc4062cf85
using Pkg

# ╔═╡ fee93343-1593-441c-8278-894fa778cc77
begin
	import Pkg
	using Pkg
	JuMP.run()
...
git-tree-sha1 = "7cd0a59bab2a58662ca88cc9286e305c452a6d01"
...
git-tree-sha1 = "d4988183b57dcea33753f4429174f444ec29f6a8"
